  ...
  <nav :class="'site-navbar--' + navbarLayoutType" class="site-navbar">
    <div class="site-navbar__header">
      <h1 class="site-navbar__brand" @click="$router.push({ name: 'home' })">
        <a class="site-navbar__brand-lg" href="javascript:">Athena-后台系统</a>
    ...
    <div class="site-navbar__body clearfix">
      ...
      <el-menu
        ...
        <el-menu-item index="1" @click="$router.push({ name: 'theme' })">
          <template slot="title">
            <el-badge value="new">
              <icon-svg class="el-icon-setting" name="shezhi"></icon-svg>
            </el-badge>
          </template>
        </el-menu-item>
        ...
        <el-menu-item class="site-navbar__avatar" index="3">
          <el-dropdown :show-timeout="0" placement="bottom">
            <span class="el-dropdown-link">
              <img :alt="userName" src="~@/assets/img/avatar.png">{{ userName }}
            </span>
