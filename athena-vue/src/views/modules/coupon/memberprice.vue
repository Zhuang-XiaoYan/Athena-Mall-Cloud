<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column align="center" header-align="center" label="会员等级id" prop="memberLevelId"></el-table-column>
      <el-table-column align="center" header-align="center" label="会员等级名" prop="memberLevelName"></el-table-column>
      ...
      >
        <template slot-scope="scope">
          <el-tag v-if="scope.row.addOther==0" type="primary">不可叠加优惠</el-tag>
          <el-tag v-else type="success">可叠加优惠</el-tag>
        </template>
      </el-table-column>
