  ...
  <el-dialog
    ...
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="80px"
      ...
      <el-form-item label="上级菜单" prop="parentName">
        ...
        <el-input v-model="dataForm.parentName" v-popover:menuListPopover :readonly="true" class="menu-list__input"
      ...
      <el-form-item v-if="dataForm.type !== 2" label="排序号" prop="orderNum">
        <el-input-number v-model="dataForm.orderNum" :min="0" controls-position="right" label="排序号"></el-input-number>
      </el-form-item>
