<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column align="center" header-align="center" label="每人限购数量" prop="seckillLimit"></el-table-column>
    ...
    <!-- 弹窗, 新增 / 修改 -->
    <div>
      <add-or-update v-if="addOrUpdateVisible" ref="addOrUpdate" :sessionId="promotionSessionId"
