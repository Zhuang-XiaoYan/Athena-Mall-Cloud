package com.zhuangxiaoyan.athena.cart.service.impl;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.TypeReference;
import com.zhuangxiaoyan.athena.cart.exception.CartExceptionHandler;
import com.zhuangxiaoyan.athena.cart.fegin.ProductFeignService;
...
import com.zhuangxiaoyan.athena.cart.vo.SkuInfoVo;
...
import static com.zhuangxiaoyan.athena.cart.constant.CartConstant.CART_PREFIX;

/**
 * @description 购物车的接口实现
  * @param: null
 * @date: 2022/9/3 7:43
 * @return:
 * @author: xjl
...
public class CartServiceImpl implements CartService {
    ...
    public CartItemVo addToCart(Long skuId, Integer num) throws ExecutionException, InterruptedException {
        ...
        if (StringUtils.isEmpty(productRedisValue)) {
            ...
            CompletableFuture<Void> getSkuInfoFuture = CompletableFuture.runAsync(() -> {
                //1、远程查询当前要添加商品的信息
                Result productSkuInfo = productFeignService.info(skuId);
    ...
    /**
     * @description 获取购物车里面的数据 包括了的临时的数据登入的数据
      * @param: cartKey
     * @date: 2022/9/3 15:11
