...
public class MongoScanner {
    ...
    /**
     * @description produceChildList
     * @param: parentName
     * @date: 2022/7/29 13:13
     * @return: java.util.List<com.zhuangxiaoyan.athena.code.entity.MongoDefinition>
     * @author: xjl
     */
     ...
     * @author: xjl
     */
    private List<String> distinctAndJoin(List<String> list, List<String> b) {
        list.removeAll(b);
        list.addAll(b);
        return list;
    }
    ...
    /**
     * @description 功能描述:解析这个集合的列名  用ForkJoin框架实现
     * @param:
    ...
    private MongoDefinition scanType() {
        MongoDefinition mongoDefinition = new MongoDefinition();
        ...
        mongoDefinition.setChild(invoke);
        mongoDefinition.setPropertyName(this.collection.getNamespace().getCollectionName());
        return mongoDefinition;
    }
    ...
    /**
     * @description 功能描述:forkJoin多线程框架的实现  通过业务拆分解析类型
     * @param: null
    ...
    /**
     * @description 功能描述:forkJoin多线程框架的实现  通过业务拆分获得属性名
     * @param: null
     * @date: 2022/7/29 13:08
     * @return:
     * @author: xjl
