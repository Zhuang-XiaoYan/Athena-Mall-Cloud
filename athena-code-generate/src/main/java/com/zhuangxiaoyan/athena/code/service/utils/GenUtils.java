...
/**
 * @description 代码生成器 ,具类
 * @date: 2022/7/29 12:56
 * @author: xjl
 */
public class GenUtils {
    ...
    /**
     * @description getMongoChildTemplates
     * @param:
     * @date: 2022/7/29 12:56
     * @return: java.util.List<java.lang.String>
     * @author: xjl
    ...
    public static void generatorCode(Map<String, String> table, List<Map<String, String>> columns, ZipOutputStream zip) {
        ...
        mainPath = StringUtils.isBlank(mainPath) ? "com.zhuangxiaoyan.athena.code" : mainPath;
        //封装模板数据
    ...
    /**
     * @description 生成mongo其他实体类的代码
     * @param: tableNames
     * @param: zip
     * @date: 2022/7/29 12:55
     * @return: void
     * @author: xjl
     */
    ...
    /**
     * @description generatorChildrenBeanCode
