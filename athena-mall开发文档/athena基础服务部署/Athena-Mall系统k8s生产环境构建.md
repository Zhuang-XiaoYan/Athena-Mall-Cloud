...
![img.png](images/权限的管理.png)

# 二、mysql的kubesphere部署

![img.png](images/数据库的集群部署.png)

# 三、Redis在KubeSphere部署

![img.png](images/redis的集群部署.png)

# 四、ElasticSearch部署和kibana在kubesphere部署

![img.png](images/es的集群部署.png)

# 五、Rabbitmq部署在kubesphere部署

![img.png](images/rabbitmq集群部署.png)

# 六、Nacos的KubeSphere部署

![img.png](images/nacos的集群部署.png)

# 七、Zipkin在KubeSphere部署

![img.png](images/zipkin的集群部署.png)

# 八、Sentinel在KubeSphere部署

![img.png](images/Sentinel.png)
...
![img.png](images/基础环境的部署1.png)
![img_1.png](images/基础环境部署2.png)
